...
#define MIN_NOT_CONNECTED_VOLTAGE 		2300//((EV_NOT_CONNECTED_VOLTAGE+EV_CONNECTED_VOLTAGE)/2)
#define MIN_CONNECTED_VOLTAGE			2000//((EV_CONNECTED_VOLTAGE+EV_CHARGING_VOLTAGE)/2)
#define MIN_CHARGING_VOLTAGE			1700//((EV_CHARGING_VOLTAGE+EV_CHARGING_VENT_REQ_VOLTAGE)/2)
#define MIN_VENT_REQ_VOLTAGE			1500//((EV_CHARGING_VENT_REQ_VOLTAGE+EV_ERROR_VOLTAGE)/2)
